({
	itemSelected : function(component, event, helper) {
        ...
        if(SelIndex){
            ...
            //debugger;
            //ert('Slected field '+selItem.text);
            //alert('Slected field '+serverResult);
            if(selItem.val){
               component.set("v.selItem",selItem);
				component.set("v.selItemName",selItem.text);
    ...
    serverCall : function(component, event, helper) {  
        ...
        }else if(searchText.trim() != last_SearchText  && regex.test(searchText) ){ 
