...
export default class AccountRecordLDS extends LightningElement {
    ...
    createAccount(){
        ...
        createRecord(recordInput).then(response =>{
            console.log('Account record created successfully.', response.id);
            this.recordId = response.id;
        }).catch(error=>{
            console.log('Error in creating Account record', error.body.message);
        })
    }
    get retAccountName(){
